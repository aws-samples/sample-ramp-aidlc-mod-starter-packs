...
| [**mobile-document-capture-on-serverless**](mobile-document-capture-on-serverless/) | Mobile capture app + serverless computer-vision extraction pipeline — e.g. digitizing printed/handwritten forms into structured data | Android/Kotlin (Compose + CameraX) + Textract/Bedrock/Step Functions CV pipeline; human-in-the-loop review; Kotlin/Android/serverless/Terraform + PBT skills |
...
├── mobile-document-capture-on-serverless/    # Mobile capture + serverless computer-vision extraction pipeline
